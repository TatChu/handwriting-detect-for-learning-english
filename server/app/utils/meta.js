...
var meta = {
    'home-page':{
        title: ' ',
        desc: 'English Study System - BossApp',
    },
    'khuyen-mai':{
        title: 'Khuyến Mãi ',
        desc: 'Nhiều chương trình khuyến mãi giá tốt, ưu đãi, giảm giá mỗi ngày, siêu hấp dẫn và tiết kiệm cho khách hàng',
    },
    'goc-bep':{
        title: 'Góc Bếp',
        desc: 'Góc chia sẻ những mẹo vặt nấu ăn, menu thực đơn, tips chọn lựa rau củ quả tươi, sạch, an toàn của các bà nội trợ và thông tin, kiến thức về thị trường thực phẩm Việt'
    },
    'meo-vat':{
        title: 'Mẹo vặt',
        desc: 'Góc chia sẻ những mẹo vặt nấu ăn, menu thực đơn, gợi ý chọn lựa rau củ quả tươi, sạch, an toàn của các bà nội trợ và thông tin, kiến thức về thị trường thực phẩm Việt'
    },
    'detail-article-gb':{
        title: '',
    ...
    'user-note':{
        title: 'Sổ tay nội trợ ',
        desc: 'Sổ tay nội trợ gồm danh sách những sản phẩm yêu thích, những mặt hàng rau củ quả được ưa chuộng của các bà nội trợ'
    },
    'user-change-pass':{
        title: 'Đổi mật khẩu ',
        desc: ''
